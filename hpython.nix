...
, digit, directory, filepath, hedgehog, papa, parsers, pretty
, process, stdenv, tasty, tasty-hedgehog, tasty-hspec, text
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    base charset deriving-compat digit papa parsers pretty text
    transformers trifecta
  ];
  testHaskellDepends = [
