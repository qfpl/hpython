...
validateListItemSyntax (ListUnpack a b c) =
  ListUnpack a <$> validateWhitespace a b <*> validateExprSyntax c
...
validateSetItemSyntax (SetUnpack a b c) =
  SetUnpack a <$> validateWhitespace a b <*> validateExprSyntax c
